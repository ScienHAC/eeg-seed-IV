...
class EEGEmotionClassifier:
    ...
    def train_model(self, data, selected_features, test_size=0.2, epochs=50, batch_size=32):
        """
    ...
    def _evaluate_model(self, X_test, y_test):
        ...
        emotion_labels_dict = {0: 'Neutral', 1: 'Sad', 2: 'Fear', 3: 'Happy'}
        emotion_names = [emotion_labels_dict[i] for i in unique_classes]
